...
public class RecentViewCoursesAdapter2 extends RecyclerView.Adapter<RecentViewCoursesAdapter2.ViewHolder> {
    ...
    public RecentViewCoursesAdapter2(List<UnitModel> recentViewCoursesList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.recent_item2, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, UnitNotesActivity.class));
            }
        });
