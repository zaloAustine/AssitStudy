...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder> {
    List<CommentModel> recentViewCoursesList;
    Context context;
    public boolean on_attach = true;
    CommentModel recentViewCourse;


    public CommentAdapter(List<CommentModel> recentViewCoursesList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.name.setText(recentViewCourse.getComment());
        holder.description.setText(recentViewCourse.getCreated_at());
